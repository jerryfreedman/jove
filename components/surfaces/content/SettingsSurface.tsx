...
export default function SettingsSurface() {
  ...
  const sectionLabel: React.CSSProperties = {
    ...
    paddingBottom:8,
    marginBottom: 14,
    borderBottom: '0.5px solid rgba(252,246,234,0.2)',
  };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          fontSize:   22, fontWeight: 400, color: 'rgba(252,246,234,0.95)', margin: 0,
        }}>
          Settings
        </h1>
      </div>
      ...
      <div style={{ padding: '20px 18px 0' }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <div style={{
            ...
            marginBottom: 18,
            background:   'rgba(26,20,16,0.2)',
            border:       '0.5px solid rgba(252,246,234,0.14)',
            borderRadius: 14,
            padding:      '14px 16px',
            ...
            {user?.avatar_url && !avatarError ? (
              <Image
                ...
                style={{
                  borderRadius: '50%',
                  flexShrink:   0,
                  border:       '0.5px solid rgba(252,246,234,0.2)',
                }}
              />
            ) : (
              <div style={{
            ...
            <div>
              <div style={{
                fontSize: 15, fontWeight: 500, color: 'rgba(252,246,234,0.95)', marginBottom: 2,
              }}>
                {user?.full_name ?? 'Your Name'}
              </div>
              <div style={{
                fontSize: 12, fontWeight: 300, color: 'rgba(252,246,234,0.44)',
              }}>
                {user?.email ?? ''}
              </div>
            </div>
          ...
          {voice && voice.sample_count > 0 ? (
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  fontSize: 10, fontWeight: 300, color: 'rgba(252,246,234,0.3)',
                  marginLeft: 'auto',
                }}>
              ...
              {[
                ...
                <div key={row.label} style={{
                  ...
                  marginBottom: 8,
                  paddingBottom:8,
                  borderBottom: '0.5px solid rgba(252,246,234,0.05)',
                }}>
                  <span style={{
                    fontSize: 10, fontWeight: 700, letterSpacing: '1px',
                    textTransform: 'uppercase', color: 'rgba(252,246,234,0.3)',
                    width: 56, flexShrink: 0, paddingTop: 1,
                  }}>
                    {row.label}
                  </span>
                  <span style={{
                    fontSize: 13, fontWeight: 300, color: 'rgba(252,246,234,0.7)',
                    lineHeight: 1.5,
                  }}>
                    {row.value}
                  </span>
            ...
            <div style={{
              ...
              <p style={{
                ...
                color:    'rgba(252,246,234,0.44)', lineHeight: 1.6,
                marginBottom: 12,
              }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <div style={{
            ...
            <div style={{
              fontSize: 13, fontWeight: 400, color: 'rgba(252,246,234,0.95)', marginBottom: 10,
            }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderColor:  pulseDays === d
                      ? 'rgba(232,160,48,0.5)'
                      : 'rgba(252,246,234,0.1)',
                    background:   pulseDays === d
                      ? 'rgba(232,160,48,0.1)'
                      : 'transparent',
                    color:        pulseDays === d
                      ? COLORS.amber
                      : 'rgba(252,246,234,0.44)',
          ...
          {[
            ...
            >
              <div style={{ flex: 1 }}>
                <div style={{
                  fontSize: 13, fontWeight: 400, color: 'rgba(252,246,234,0.95)', marginBottom: 2,
                }}>
                  {pref.label}
                </div>
                <div style={{
                  fontSize: 11, fontWeight: 300, color: 'rgba(252,246,234,0.4)',
                }}>
                  {pref.sub}
                </div>
              </div>
        ...
        <div style={{ marginBottom: 28 }}>
          <div style={{
            ...
            <div style={{
              ...
              textTransform:'uppercase', color: 'rgba(252,246,234,0.28)',
            }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button
                  ...
                  style={{
                    ...
                    background:    newKbName.trim() && newKbDesc.trim() && !savingKb
                      ? 'linear-gradient(135deg, #C87820, #E09838)'
                      : 'rgba(252,246,234,0.08)',
                    color:         newKbName.trim() && newKbDesc.trim() && !savingKb
                      ? 'white' : 'rgba(252,246,234,0.3)',
                ...
                <button
                  ...
                  style={{
                    ...
                    border:     '0.5px solid rgba(252,246,234,0.12)',
                    background: 'transparent', color: 'rgba(252,246,234,0.4)',
          ...
          {kb.length === 0 && !showAddKb && (
            <div style={{
              ...
              <p style={{
                fontSize: 13, fontWeight: 300,
                color:    'rgba(252,246,234,0.44)', marginBottom: 4,
              }}>
          ...
          {kb.map(item => (
            <div
              ...
              style={{
                ...
                border:       item.is_active_deal
                  ...
                  : '0.5px solid rgba(252,246,234,0.14)',
                borderRadius: 14,
                padding:      '13px 16px',
                marginBottom: 8,
                boxShadow:    '0 1px 6px rgba(0,0,0,0.2)',
            ...
            >
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{
                    fontSize: 14, fontWeight: 500, color: 'rgba(252,246,234,0.95)',
                    marginBottom: 2,
                    overflow: 'hidden',
                ...
                <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                  ...
                  <div style={{
                    fontSize:     8, fontWeight: 600, color: 'rgba(252,246,234,0.3)',
                    background:   'rgba(252,246,234,0.05)',
                    borderRadius: 20, padding: '2px 7px',
                  }}>
                    v{item.version}
                  </div>
              ...
              {expandedKb === item.id && (
                ...
                >
                  ...
                  <div style={{
                    ...
                    paddingTop: 10, borderTop: '0.5px solid rgba(252,246,234,0.06)',
                  }}>
                    <button
                      ...
                      style={{
                        ...
                        color:         item.is_active_deal
                          ? COLORS.teal : 'rgba(252,246,234,0.4)',
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <p style={{
              fontSize: 10, fontWeight: 300,
              color:    'rgba(252,246,234,0.28)', marginBottom: 2,
            }}>
              Jove · v1.0
            </p>
            <p style={{
              fontSize: 10, fontWeight: 300,
              color:    'rgba(252,246,234,0.22)',
            }}>
