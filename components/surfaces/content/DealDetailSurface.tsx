...
// ── COMPONENT ──────────────────────────────────────────────
export default function DealDetailSurface({ dealId }: { dealId?: string }) {
  ...
  const handleSaveNextAction = async () => {
    if (!nextActionInput.trim() || !userId || !dealId) return;
    await supabase
      .from('deals')
      .update({
  ...
  const handleCloseDeal = async () => {
    if (!userId || !closeType || !dealId) return;
  ...
  const handleLogInteraction = async () => {
    if (!logContent.trim() || !userId || !dealId) return;
    setSavingLog(true);
  ...
  const inputStyle: React.CSSProperties = {
    width:        '100%',
    background:   'rgba(252,246,234,0.08)',
  ...
  return (
    ...
    <div style={{
      ...
      <div style={{
        ...
        borderBottom: '0.5px solid rgba(232,160,48,0.16)',
        flexShrink:   0,
        zIndex:       20,
      }}>
        <div style={{
        ...
        <div style={{
          ...
          <textarea
            ...
            style={{
              ...
              fontSize:   13,
              fontWeight: 300,
              color:      notesInput ? 'rgba(252,246,234,0.9)' : 'rgba(252,246,234,0.3)',
              fontFamily: "'DM Sans', sans-serif",
              resize:     'none',
              lineHeight: 1.55,
              padding:    0,
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button
                ...
                style={{
                  ...
                  color:         newContactName.trim() ? 'white' : 'rgba(252,246,234,0.3)',
                  fontSize:      11,
                  fontWeight:    700,
                  letterSpacing: '1.5px',
                  textTransform: 'uppercase',
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {contact.relationship_summary && (
                  <div style={{
                    ...
                    marginTop:  4,
                    paddingTop: 8,
                    borderTop:  '0.5px solid rgba(252,246,234,0.06)',
                  }}>
                    {contact.relationship_summary}
                  </div>
                )}
      ...
      <>
        ...
        <div style={{
          ...
          <div style={{
            ...
            height:       4,
            borderRadius: 2,
            background:   'rgba(252,246,234,0.12)',
    ...
    {showCloseScreen && (
      <div style={{
        ...
        <div style={{
          ...
          borderBottom: '0.5px solid rgba(252,246,234,0.08)',
          display:     'flex',
          alignItems:  'center',
