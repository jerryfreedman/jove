...
export default function MeetingsSurface() {
  ...
  const fetchData = useCallback(async () => {
    ...
    if (!user) {
      // For auth redirects, use router.push('/')
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          flex: 1,
          fontFamily: "'Cormorant Garamond', serif",
          fontSize: 22, fontWeight: 400, color: '#E0D7C8', margin: 0,
        }}>
          Meetings
        </h1>
        ...
        <button
          ...
          style={{
            ...
            letterSpacing:'1px',
            textTransform:'uppercase',
            color:        importing ? 'rgba(224,213,200,0.3)' : COLORS.amber,
            fontFamily:   "'DM Sans', sans-serif",
          }}
        >
            ...
            {detectedMeetings.map((m, i) => (
              <div key={i} style={{
                ...
                borderBottom: i < detectedMeetings.length - 1
                  ? '0.5px solid rgba(224,213,200,0.06)'
                  : 'none',
              }}>
                <input
                  type="checkbox"
                ...
                <div style={{ flex: 1 }}>
                  <div style={{
                    fontSize: 14, fontWeight: 400, color: '#E0D7C8',
                    marginBottom: 3,
                  }}>
                    {m.title}
                  </div>
        ...
        {upcoming.length > 0 && (
          <div style={{ marginBottom: 20 }}>
            <div style={{
              ...
              textTransform:'uppercase', color: 'rgba(224,213,200,0.3)',
              marginBottom: 10,
            }}>
              Upcoming
            </div>
        ...
        {!loading && meetings.length === 0 && !showConfirm && (
          <div style={{ textAlign: 'center', padding: '60px 0' }}>
            <p style={{
              ...
              color:      'rgba(224,213,200,0.4)', marginBottom: 8,
            }}>
              No meetings yet.
            </p>
            <p style={{
              fontSize: 13, fontWeight: 300, color: 'rgba(224,213,200,0.3)',
            }}>
